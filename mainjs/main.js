const City = ["Toshkent", "Samarqand", "Buxoro", "Farg'ona", "Navoiy", "Andijon", "Jizzax", "Xorazm", "Buxoro", "Namangan", "Qashqadaryo"];
const Position = ["Reactjs", "Nodejs", "Java", "Python", "C#", "C++"];
...
const getRow = ({
  ...
  return `
    <tr>
      ...
      <td class = "text-end">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pupilModal" onclick="editPupil(${id})">O'zgartirish</button>
        <button class="btn btn-danger" onclick="deletePupil(${id})">O'chirish</button>
      </td>
      </tr>
      `;
};
